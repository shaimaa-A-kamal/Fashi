...
@section('content')
 ...
 <x-layouts.breadcrumb :message="'Blog'"/>
                    ...
                    <div class="recent-post">
                        ...
                        <div class="recent-blog">
                            <a href="#" class="rb-item">
                                <div class="rb-pic">
                                    <img src="{{url('assets/img/blog/recent-1.jpg')}}" alt="">
                                </div>
                                <div class="rb-text">
                            ...
                            <a href="#" class="rb-item">
                                <div class="rb-pic">
                                    <img src="{{url('assets/img/blog/recent-2.jpg')}}" alt="">
                                </div>
                                <div class="rb-text">
                                    <h6>The Personality Trait That Makes...</h6>
                                    <p>Fashion <span>- May 19, 2019</span></p>
                            ...
                            <a href="#" class="rb-item">
                                <div class="rb-pic">
                                    <img src="{{url('assets/img/blog/recent-3.jpg')}}" alt="">
                                </div>
                                <div class="rb-text">
                                    <h6>The Personality Trait That Makes...</h6>
                                    <p>Fashion <span>- May 19, 2019</span></p>
                            ...
                            <a href="#" class="rb-item">
                                <div class="rb-pic">
                                    <img src="{{url('assets/img/blog/recent-4.jpg')}}" alt="">
                                </div>
                                <div class="rb-text">
                                    <h6>The Personality Trait That Makes...</h6>
                                    <p>Fashion <span>- May 19, 2019</span></p>
